...
<%@ page import="ru.academits.nekrasovgleb.model.Contact" %>
        ...
        <tr>
            <td>
                <label class="select-me-label">
                    <input type="checkbox" name="checked-id" value="<%= contact.getId()%>" class="select-me"/>
                </label>
            </td>
            <td>
                <% out.println(number); %>
            ...
            <td>
                <button class="btn btn-primary" type="submit" name="checked-id" value="<%= contact.getId()%>">Удалить</button>
            </td>
        </tr>
